...
import com.jeongbj.presentation.feature.book.search.SearchFilter
    ...
    LazyRow(
        ...
        items(SearchFilter.entries) { filter ->
            FilterChip(
                ...
                isSelected = filter == state.searchFilter,
                onClick = { onAction(SearchAction.OnFilterSelected(filter)) }
            )
        }
    }
}
